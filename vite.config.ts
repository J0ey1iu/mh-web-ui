  ...
  return {
    ...
    define: {
      __APP_CONFIG__: JSON.stringify({
        ...
        apiManagementProviderConfigs: isProd ? "{wcm_api_management_provider_configs}" : "//localhost:8005/api/v1/management/provider-configs",
        apiManagementProviderConfig: isProd ? "{wcm_api_management_provider_config}" : "//localhost:8005/api/v1/management/provider-configs/{name}",
